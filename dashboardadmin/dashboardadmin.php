      ...
      <div class="mt-4 p-3">
        ...
        <div class="cardImg">
          <a href="generatelaporan/generatelaporan.php">
            <img src="../assets/generatelaporann.png" alt="daftar buku" style="max-width: 90%;" width="600px">
          </a>
        </div>
        <div class="cardImg">
          <a href="buku/tambahBuku.php">
          <img src="../assets/tambahbrgkategori.png" alt="daftar buku" style="max-width: 90%;" width="600px">
          </a>
        </div>

        <div class="cardImg">
          <a href="peminjaman/daftarpinjam.php">
            <img src="../assets/peminjamann.png" alt="daftar buku" style="max-width: 90%;" width="600px">
          </a>
        </div>
        <div class="cardImg">
          <a href="pengembalian/daftarpengembalian.php">
          <img src="../assets/pengembalianadmin.png" alt="daftar buku" style="max-width: 90%;" width="600px">
          </a>
        </div>
        <div class="cardImg">
        ...
        <div class="cardImg">
          <a href="akunPetugas/register.html">
          <img src="../assets/buatakunpetugass.png" alt="daftar buku" style="max-width: 90%;" width="600px">
          </a>
        </div>
        </div>
