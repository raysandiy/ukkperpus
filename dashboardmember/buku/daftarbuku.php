...
body {
    ...
    margin: 0; /* Remove default margin */
        ...
        .navbar-brand {
            ...
            left: 0;
            margin: 10px;
            /* Add margin to adjust positioning */
        }
        ...
        .btn-tandai {
            ...
            margin-right: 0px;
            /* Sesuaikan jarak dengan tombol Detail */
        }
...
<body>
    <h2 class="title" style="text-shadow: 0 0 5px red; color:black">Daftar Buku</h2>
    ...
    <div class="p-4 mt-5">
        ...
        <div class="layout-card-custom">
            <?php foreach ($buku as $item) : ?>
                ...
                $buttonColor = $isSaved ? 'cyan' : '#3c4a6b';
                ...
                // Mengambil id buku untuk mencari rata-rata rating
                $id_buku = $item["id"];
                ...
                <div class="card" style="width: 15rem;">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">penulis : <?= $item["penulis"]; ?></li>
                    ...
                    <div class="card-body text-center"> <!-- Mengatur tombol detail menjadi berada di tengah -->
                        <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"> <!-- Ganti action ke halaman ini sendiri -->
                            ...
                            <a class="btn btn-primary btn-ulasan" href="ulasanbuku.php?id=<?= $item["id"]; ?>">Ulasan</a>
